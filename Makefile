...
LDFLAGS=/NODEFAULTLIB:libcmt.lib /NODEFAULTLIB:msvcprt.lib /RELEASE /MANIFEST:NO /DEBUG:FULL /OPT:REF /OPT:ICF /OPT:LBR /DEF:..\src\kernel64.def /OUT:KERNEL64.dll /DLL /MACHINE:X86
